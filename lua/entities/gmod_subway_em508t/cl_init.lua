...
ENT.ButtonMap["Fusebox"] = {
    ...
    hide=0.8,
    buttons = {
        {ID = "FuseboxCoverC",x=0,y=0,w=150,h=380, tooltip ="", noTooltip = true},
        {ID = "FuseboxCoverO",x=150,y=0,w=150,h=380, tooltip="",noTooltip = true},
        --Верхний ряд
...
function ENT:Think()
    ...
    for i=1,12 do 
		...
		self:ShowHideSmooth("PR"..i.."Fuse", ((self:GetPackedBool("PR"..i.."FState") and 1 or 0) - hid2) * (hid > 0.01 and 1 or 0))
    end
    for i=1,36 do 
		...
		self:ShowHideSmooth("PRL"..i.."_fuse",((self:GetPackedBool("PRL"..i.."State") and 1 or 0) - hid) * (fboxcover > 0.01 and 1 or 0))
		local hida = self:Animate("PRL"..i.."A_fuse",self:GetPackedBool("PRL"..i.."AState") and 0 or 1,0,1,5,false)
		self:ShowHideSmooth("PRL"..i.."A_fuse",((self:GetPackedBool("PRL"..i.."AState") and 1 or 0) - hida) * (fboxcover > 0.01 and 1 or 0))
    end
